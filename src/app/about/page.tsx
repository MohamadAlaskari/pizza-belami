...
export const metadata: Metadata = {
  title: 'Über Uns',
  description: 'Erfahren Sie mehr über die Geschichte und das Team von Pizza Belami 2 in Bremen.',
};
  ...
  return (
    <div className="space-y-12">
      <section className="text-center">
        <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl">Über Belami Bites</h1>
        ...
        <div className="md:flex">
          <div className="md:w-1/2">
            <Image
              ...
              alt="Team von Belami Bites in der Küche"
              width={600}
              height={450}
          ...
          <div className="md:w-1/2 p-6 md:p-8">
            ...
            <CardContent className="p-0 space-y-4 text-muted-foreground">
              <p>
                Willkommen bei Belami Bites, ehemals bekannt als Pizza Belami 2! Im Herzen von Bremen, Am Dobben 125, 
                sind wir seit vielen Jahren Ihr zuverlässiger Partner für authentische italienische Pizza und eine Vielfalt 
              ...
              <p>
                Unser Team ist das Herzstück von Belami Bites. Mit Leidenschaft und Engagement arbeiten wir jeden Tag daran, 
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            ...
            den Belami Bites zu bieten hat. Wir freuen uns auf Sie!
          </p>
        </div>
        <div className="rounded-lg overflow-hidden shadow-md">
          <Image
            src="https://placehold.co/500x350.png"
            alt="Freundliche Atmosphäre im Belami Bites"
            width={500}
            height={350}
